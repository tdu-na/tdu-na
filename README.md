...
- 小説、歴史、学術書を読んだり
- 自分の内省のために、日記を書いたり
- 英語、中国語、エスペラント語をちょこちょこ勉強しています。
  - 中国語はHello ChineseとPeak Chineseというアプリで勉強していますが、あまり身についた感じしない… ←自分がちゃんと努力してないのが悪い
  - エスペラント語はDuolingoで勉強しています。

## 研究

<!-- 専門はベーシックインカムあたりの経済学が主となっています。 -->
学生の頃は、認知科学分野の信念更新を研究していました。ポジティブな情報とネガティブな情報による信念更新の非対称性への検討などをやっています。
私が所属していた研究室の特質上、強化学習にもある程度知っています。
...
私の研究室で開催したアドベントカレンダーで、こんな記事書いてました。
- [多項ロジスティック回帰の解釈について私的にまとめてみた #回帰分析 - Qiita](https://qiita.com/tduna/items/02124a4d80d2bd2df5b3)
- [【学生向け俺的就活フロー】修士1年生による就活の流れについて｜tduna](https://note.com/tduna/n/n41483afd4b8d)
- [【メタ分析】たった一つの研究ではわからない真実へ：学部生・院生のための簡易的なメタ分析の道（と私のためのメモ）｜tduna](https://note.com/tduna/n/nf607a40738e8?sub_rt=share_pb)
- [【ちょこっと言語学習】 Duolingo と SuperChinese をやって数日経過したので，それらについての自分なりの感想と言語学習モチベーションについて｜tduna](https://note.com/tduna/n/n70b03d614008?sub_rt=share_pb)
...
- パソコン：
  ...
  - Windows デスクトップパソコン (FRZAB550W/A)
    ...
    - GPU: NVIDIA GeForce RTX 5070 12GB (MSI / ホワイト)
    - メモリ: 32GB (16GB×2) DDR4-3200
    - ストレージ: 1TB NVMe SSD
    - マザーボード: MSI MPG B550 GAMING PLUS
    - クーラー: 360mm 水冷CPUクーラー (ホワイト)
